                    ...
                    child: Row(
                      children: [
                        CircularPercentIndicator(
                          ...
                          lineWidth: 5.0,
                          percent:
                              _viewProjectController.checkListProgress.value,
                          center: Text(
                        ...
                        itemBuilder: (context, index) {
                          return Padding(
                            ...
                            child: CheckboxListTile(
                                title: Text(_viewProjectController.project.value
                  ...
                  Padding(
                    ...
                    child: SizedBox(
                      ...
                      child: ListView.builder(
                          ...
                          itemCount: _viewProjectController.subProjects.length,
                          itemBuilder: (context, index) {
                            return SizedBox(
                              height: 40,
                              width: 200,
                              child: ProjectInfoCard(
                                  project: _viewProjectController.project.value,
                                  onDeleteClicked:
